...
export function CtaSection() {
  return (
    <section className="bg-[#F8FAFC] pb-16">
      <div className="site-container relative min-h-[350px] overflow-hidden rounded-[24px] border border-[#60A5FA]/30 bg-[#0B4EDB] text-white shadow-[0_30px_70px_rgba(37,99,235,.26)]">
        <Image src={`${assetRoot}/drivemate-cta.png`} alt="Armada mobil dan motor DriveMate" fill sizes="1176px" className="scale-[1.08] object-cover object-[58%_center]" />
        ...
        <div className="relative z-10 max-w-[610px] px-7 py-12 sm:px-11 lg:px-14 lg:py-16">
          <h2 className="text-3xl font-bold leading-tight tracking-[-0.045em] sm:text-[42px]">Siap Menjelajahi Jogja?</h2>
