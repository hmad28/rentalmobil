      ...
      <div className="site-container relative grid items-center gap-14 md:grid-cols-[.9fr_1.1fr] lg:gap-20">
        <div className="relative mx-auto w-full max-w-[520px] pb-5 pr-5">
          ...
          <div className="relative aspect-square overflow-hidden rounded-2xl shadow-[0_24px_70px_rgba(30,64,175,.18)]">
            <Image src={`${assetRoot}/about.webp`} alt="Sewa Mobil Jogja bersama DriveMate" fill sizes="(min-width:768px) 45vw, 100vw" className="object-cover hue-rotate-[212deg] saturate-[.92]" />
          </div>
        </div>
        <div>
          <p className="mb-3 text-xs font-bold uppercase tracking-[0.18em] text-[#2563EB]">Welcome to DriveMate</p>
          <h2 className="text-3xl font-bold leading-[1.15] tracking-[-0.035em] text-[#111827] md:text-[2.6rem]">Sewa Mobil Jogja – <span className="text-[#2563EB]">Jelajahi Yogyakarta</span> dengan Nyaman dan Fleksibel</h2>
          <div className="mt-6 space-y-4 text-[15px] leading-7 text-[#64748B] md:text-base">
            <p>Nikmati kemudahan berkeliling Yogyakarta bersama <strong className="font-semibold text-[#0F172A]">DriveMate</strong>, solusi transportasi terbaik untuk liburan, perjalanan bisnis, atau keperluan keluarga. Tersedia berbagai pilihan mobil terbaru — dari city car hingga kendaraan keluarga luas dan nyaman.</p>
